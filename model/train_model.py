...
# --- Domain constants and the "true" energy formula ---
# Kept at module level (no side effects) so calculate_kwh is importable and
# testable without triggering a full data-generation + training run.
